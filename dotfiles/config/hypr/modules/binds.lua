...
hl.bind("F6", hl.dsp.exec_cmd("brightnessctl set 10%-"), {repeating = true})
...
hl.bind("F2", hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle"),     { locked = true, repeating = true })


hl.bind("CTRL + Tab",         hl.dsp.exec_cmd("snappy-switcher next --mod ctrl"))
hl.bind("CTRL + SHIFT + Tab", hl.dsp.exec_cmd("snappy-switcher prev --mod ctrl"))
